# taken from https://github.com/philipperemy/keras-activations/blob/master/keract/keract.py
...
def display_activations(activations, item_num, folder_path, item_prefixes):
    import numpy as np
    ...
    for i, activation_map in enumerate(activation_maps):
        ...
        plt.title(layer_names[i] + ' for train image #' + str(item_num))
        plt.imshow(activations, interpolation='None', cmap='jet')
        plt.savefig(folder_path + item_prefixes[layer_names[i]] + str(item_num) + '.png', format='png')